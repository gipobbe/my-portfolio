        ...
        <div className={`contact${isContactOpen ? " contactme-open" : ""}`}>
          ...
          <div className="contactme-container">
            ...
            <div className="contactme-info">
              <p>Metteti in contatto con me: </p>
              <p>
              ...
              <p>
                ...
                <Obfuscate
                  email={email}
                  headers={{
                    subject: "Unisciti al nostro team!",
                    body: "Giovanni, ti vogliamo nel nostro team!",
                  }}
                />
              </p>
            </div>
